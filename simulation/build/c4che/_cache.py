...
CXXFLAGS_PYEXT = ['-pthread', '-fno-strict-aliasing', '-fwrapv', '-fno-strict-aliasing', '-fvisibility=hidden', '-Wno-array-bounds']
...
INCLUDES_PYEMBED = ['/root/anaconda3/envs/hpcc/include/python2.7']
INCLUDES_PYEXT = ['/root/anaconda3/envs/hpcc/include/python2.7']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_PYEMBED = ['/root/anaconda3/envs/hpcc/lib']
LIBPATH_PYEXT = ['/root/anaconda3/envs/hpcc/lib']
LIBPATH_PYTHON2.7 = ['/root/anaconda3/envs/hpcc/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
...
LINKFLAGS_PYEMBED = ['-Wl,-rpath=/root/anaconda3/envs/hpcc/lib', '-Wl,--no-as-needed', '-Wl,--sysroot=/']
LINKFLAGS_PYEXT = ['-Wl,-rpath=/root/anaconda3/envs/hpcc/lib', '-Wl,--no-as-needed', '-Wl,--sysroot=/', '-pthread', '-Wl,-rpath=/root/anaconda3/envs/hpcc/lib', '-Wl,--no-as-needed', '-Wl,--sysroot=/']
...
NS3_EXECUTABLE_PATH = ['/root/zliu/Lomas/simulation/build/src/emu', '/root/zliu/Lomas/simulation/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/5', '/root/zliu/Lomas/simulation/build']
...
PYFLAGS_OPT = '-O'
PYO = 1
PYTHON = ['/root/anaconda3/envs/hpcc/bin/python']
PYTHONARCHDIR = '/usr/local/lib/python2.7/site-packages'
PYTHONDIR = '/usr/local/lib/python2.7/site-packages'
PYTHON_CONFIG = '/root/anaconda3/envs/hpcc/bin/python-config'
PYTHON_VERSION = '2.7'
...
cfg_files = ['/root/zliu/Lomas/simulation/build/ns3/config-store-config.h', '/root/zliu/Lomas/simulation/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
